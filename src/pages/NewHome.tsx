  ...
  return (
    <div className="pt-16 sm:pt-20">
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-white">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(244,168,176,0.08),transparent_50%)]"></div>

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          <div className="inline-flex items-center gap-2 glass px-4 py-2 rounded-full mb-8">
            <Sparkles className="w-4 h-4 text-maroon-700" />
            <span className="text-sm font-medium text-maroon-700">Powered by Bolt on Replit</span>
          </div>

          <h1 className="text-6xl sm:text-7xl lg:text-8xl font-bold mb-6 gradient-maroon bg-clip-text text-transparent leading-tight">
          ...
          <p className="text-xl sm:text-2xl text-gray-700 mb-12 max-w-3xl mx-auto leading-relaxed">
            ...
            <span className="block mt-2 text-maroon-700 font-semibold">Just beautiful websites on demand.</span>
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {stats.map((stat, index) => (
              <GlassCard key={index} hover={false} className="text-center">
                <div className="text-4xl font-bold text-maroon-700 mb-2">{stat.value}</div>
      ...
      <section className="py-20 bg-gray-50 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold mb-6 text-gray-900">Why Choose Us?</h2>
              ...
              return (
                <GlassCard key={index}>
                  <div className="flex flex-col items-center text-center">
                    <div className="gradient-maroon w-16 h-16 rounded-2xl flex items-center justify-center mb-6">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold mb-6 text-gray-900">Simple Process</h2>
            <p className="text-xl text-gray-600">From idea to launch in 24 hours</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <GlassCard key={index}>
                <div className="text-6xl font-bold text-maroon-200 mb-4">{item.step}</div>
      ...
      <section id="pricing" className="py-20 bg-gradient-to-br from-maroon-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold mb-6 text-gray-900">Subscription Plans</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-6">
            {[
              ...
              <GlassCard
                key={index}
                className={`${
                  plan.popular ? 'ring-2 ring-maroon-600 shadow-xl' : ''
                } flex flex-col relative`}
              >
                {plan.popular && (
                  <div className="absolute top-0 right-0 gradient-maroon text-white px-4 py-1 text-sm font-semibold rounded-bl-xl rounded-tr-xl">
                    Popular
                  </div>
                )}
                <div className="flex-1">
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">{plan.name}</h3>
                  <div className="text-4xl font-bold text-maroon-700 mb-2">{plan.price}</div>
                  <p className="text-sm text-gray-600 mb-6">{plan.description}</p>

                  <ul className="space-y-3 mb-6">
                    {plan.features.map((feature, idx) => (
                      <li key={idx} className="flex items-start gap-2 text-sm text-gray-700">
                        <Check className="w-5 h-5 text-maroon-700 flex-shrink-0 mt-0.5" />
                        {feature}
                      </li>
                    ))}
                  </ul>
      ...
      <section className="py-20 gradient-maroon relative overflow-hidden">
